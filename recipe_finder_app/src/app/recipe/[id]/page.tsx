      ...
      <div className="relative min-h-screen">
        ...
        <div className="min-h-screen flex items-center justify-center text-center p-4">
          <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg max-w-md">
            <h2 className="text-2xl font-semibold text-gray-800">Meal not found</h2>
            ...
            >
              ...
              <div className="px-8 py-6 border-t border-gray-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    { ingredient: item.strIngredient1, measure: item.strMeasure1 },
                    { ingredient: item.strIngredient2, measure: item.strMeasure2 },
                    { ingredient: item.strIngredient3, measure: item.strMeasure3 },
                    { ingredient: item.strIngredient4, measure: item.strMeasure4 },
                  ]
